...
const rolePaths: Record<string, string[]> = {
  ...
  production_manager: ['/formulations', '/production-planning', '/production-orders', '/production-control', '/production-warehouse', '/macropack', '/finished-goods', '/shift-reports', '/daily-production-report', '/production-efficiency', '/production-report', '/reports/process-loss'],
  supervisor: ['/formulations', '/production-planning', '/production-orders', '/production-control', '/production-warehouse', '/macropack', '/finished-goods', '/shift-reports', '/daily-production-report', '/production-efficiency', '/production-report', '/reports/process-loss'],
  operator: ['/formulations', '/production-planning', '/production-orders', '/production-control', '/production-warehouse', '/macropack', '/finished-goods', '/shift-reports', '/daily-production-report', '/production-efficiency', '/production-report', '/reports/process-loss'],
  logistics: ['/dispatch', '/dispatch-planning', '/fleet'],
  finance: ['/goods-received', '/sage-posting-review', '/formulations', '/production-orders', '/production-control', '/production-warehouse', '/finished-goods', '/reports/gross-margin', '/production-report', '/reports/process-loss', '/reports/rm-reconciliation', '/reconciliation'],
  accountant: ['/goods-received', '/sage-posting-review', '/formulations', '/production-orders', '/production-control', '/production-warehouse', '/finished-goods', '/reports/gross-margin', '/production-report', '/reports/process-loss', '/reports/rm-reconciliation', '/reconciliation'],
};
